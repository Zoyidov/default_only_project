  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Data of Cards"),
      ),
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return currencies.isNotEmpty
              ...
              children: List.generate(
                currencies.length,
                    (index) {
                  CardsModel cardsModel = currencies[index];
                  String colorA =
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(cardsModel.cardType,style: TextStyle(color: Colors.teal,fontWeight: FontWeight.w600),)),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(left: 40),
                                child: Align(
                              ...
                              Padding(
                                ...
                                child: Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(cardsModel.expireDate,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 10),)),
                              ),
                            ],
                          ),
                        ),
