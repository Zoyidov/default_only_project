...
import 'package:login_screen_homework/ui/add_contact/contact_profile.dart';
        ...
        actions: [
          Padding(
            ...
            child: Center(
              child: ZoomTapAnimation(
                onTap: () {
                  if (controller1.text.isNotEmpty && controller3.text.isNotEmpty) {
                    db.insertContact(
                      Contact(
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        backgroundColor: Colors.black,
                        content: Text(
                          '[ ${controller1.text}${controller2.text}] Successfully Added to Contact!',
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        backgroundColor: Colors.black,
                        content: Text('Please enter the details fully!',style: TextStyle(color: Colors.red),
                        ),
                        duration: const Duration(seconds: 2),
                      ),
                    );
